...
class AddTestCase(TestCase):
    ...
    def test_add_product(self):
        ...
        image_elem.send_keys(r"D:\Програмирование CodifyLab\Python\eshop\media\selenium-logo.png")
        sleep(3)
        button_elem.click()
        sleep(3)
        driver.close()
    ...
    def test_add_profile(self):
        ...
        photo_elem.send_keys(r"D:\Програмирование CodifyLab\Python\eshop\media\selenium-logo.png")
        sleep(3)
        button_elem.click()
        sleep(3)
        driver.close()
